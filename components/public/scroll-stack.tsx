...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  rotationAmount = 0,
  blurAmount = 0,
  useWindowScroll = true, // default to true since it's the main page scroll
  onStackComplete
}) => {
  ...
  return (
    ...
    >
      <div 
        className={useWindowScroll ? "scroll-stack-inner w-full" : "scroll-stack-inner pt-[20vh] px-20 min-h-screen"}
        style={useWindowScroll ? { paddingBottom: `${React.Children.count(children) * 40}vh` } : { paddingBottom: '50rem' }}
      >
        {children}
